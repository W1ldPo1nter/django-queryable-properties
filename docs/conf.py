...
# -*- coding: utf-8 -*-
#
# queryable_properties documentation build configuration file
#
...
meta = {}
exec(open(os.path.join(project_root, 'queryable_properties', '__init__.py'), 'rb').read(), {}, meta)
...
htmlhelp_basename = 'queryable_properties_doc'
