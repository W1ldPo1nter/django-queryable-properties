...
.. note::
   ...
   queryset after they have been explicitly selected. Read more about this in the documentation for annotatable
   queryable properties (TODO: ref).
```
...
.. note::
   ...
   option if their setter is used after they were selected. Read more about this in the documentation for annotatable
   queryable properties (TODO: ref).
```
