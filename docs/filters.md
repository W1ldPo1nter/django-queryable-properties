...
.. note::
   ...
   Read more about this in :ref:`the-annotationmixin-and-custom-filter-implementations`.
```
...
.. caution::
   ...
   :ref:`the-annotationmixin-and-custom-filter-implementations`) that override this method as well (the implementations
   override each other).
